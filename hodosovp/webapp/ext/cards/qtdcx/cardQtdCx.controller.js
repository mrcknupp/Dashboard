(function () {
	...
	sap.ui.controller("hodos.hodosovp.ext.cards.qtdcx.cardQtdCx", {
		...
		search: function () {
			...
			oModel.read("/" + this.entitySet.name, {
				...
				success: function (oData, response) {
					var oQtdcx = (oData.results.length > 0) ? oData.results : [];
					oView.setModel(new sap.ui.model.json.JSONModel(oQtdcx), "qtdcx");
				},
