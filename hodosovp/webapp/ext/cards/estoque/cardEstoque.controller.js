(function () {
	...
	sap.ui.controller("hodos.hodosovp.ext.cards.estoque.cardEstoque", {
		...
		search: function () {
			...
			var aFilters = [new sap.ui.model.Filter("Pais", sap.ui.model.FilterOperator.EQ, oFilters.Pais),
				...
				new sap.ui.model.Filter("Condensed", sap.ui.model.FilterOperator.EQ, "X"),
			...
			oModel.read("/" + this.entitySet.name, {
				...
				success: function (oData, response) {
					var oEstoque = (oData.results.length > 0) ? oData.results : [];
					oView.setModel(new sap.ui.model.json.JSONModel(oEstoque), "estoque");
				},
