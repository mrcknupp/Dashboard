(function () {
	...
	sap.ui.controller("hodos.hodosovp.ext.cards.encantamento.cardEncantamento", {

		onInit: function () {
			// this.getView().setModel(new sap.ui.model.json.JSONModel({
			// 	encantamentoImage: sap.ui.require.toUrl("hodos/hodosovp") + "/img/radar.png"
			// }), "encantamentoModel");
		...
		search: function () {
			...
			oModel.read("/" + this.entitySet.name, {
				...
				success: function (oData, response) {
					...
					oView.setModel(new sap.ui.model.json.JSONModel(oFunil), "encantamento");
				},
		...
		onEncantamentoPress: function (oEvent) {
