...
! function (A, e) {
	...
	return function (A) {
		...
		var v = ["INPUT", "TEXTAREA", "SELECT"],
			y = function () {
				function A(e, t, r, B) {
					...
					! function (A, e) {
						if (!(A instanceof e)) throw new TypeError("Cannot call a class as a function")
					}(this, A), this.parent = t, this.tagName = e.tagName, this.index = B, this.childNodes = [], this.listItems = [], "number" ==
					...
					if (this.style = {
							...
							borderRadius: (e instanceof S.HTMLInputElement || e instanceof HTMLInputElement) && O ? (0, T.getInputBorderRadius)(e) : (0, o.parseBorderRadius)
								(D),
					...
					"IMG" === e.tagName && e.addEventListener("load", function () {
						...
						}), this.image = b(e, r), this.bounds = O ? (0, T.reformatInputBounds)((0, K.parseBounds)(e, L, _)) : (0, K.parseBounds)(e, L, _),
				...
				return r(A, [{
					...
					key: "isVisible",
					value: function () {
						return !(0, B.contains)(this.style.display, i.DISPLAY.NONE) && this.style.opacity > 0 && this.style.visibility === p.VISIBILITY
							.VISIBLE
					}
				}, {
					...
					key: "isInlineLevel",
					value: function () {
						return (0, B.contains)(this.style.display, i.DISPLAY.INLINE) || (0, B.contains)(this.style.display, i.DISPLAY.INLINE_BLOCK) ||
							(0, B.contains)(this.style.display, i.DISPLAY.INLINE_FLEX) || (0, B.contains)(this.style.display, i.DISPLAY.INLINE_GRID) ||
							(0, B.contains)(this.style.display, i.DISPLAY.INLINE_LIST_ITEM) || (0, B.contains)(this.style.display, i.DISPLAY.INLINE_TABLE)
					}
				}, {
		...
		var s = e.TextBounds = function A(e, t) {
			...
			o = (e.parseTextBounds = function (A, e, t) {
				for (var r = 0 !== e.style.letterSpacing ? (0, a.toCodePoints)(A).map(function (A) {
						...
						}) : (0, a.breakWords)(A, e), c = r.length, l = t.parentNode ? t.parentNode.ownerDocument.defaultView : null, u = l ? l.pageXOffset :
						0, Q = l ? l.pageYOffset : 0, w = [], U = 0, g = 0; g < c; g++) {
					var C = r[g];
		...
		e.Proxy = function (A, e) {
			...
			return new Promise(function (n, B) {
				...
				if (s.onload = function () {
					...
					}, s.onerror = B, s.open("GET", t + "?url=" + encodeURIComponent(A) + "&responseType=" + a), "text" !== a && s instanceof XMLHttpRequest &&
		...
		var o = e.LETTER_NUMBER_MODIFIER = 50,
			...
			V = e.codePointsToCharacterClasses = function (A) {
				...
				return A.forEach(function (A, B) {
					var a = D.get(A);
					if (a > o ? (n.push(!0), a -= o) : n.push(!1), -1 !== ["normal", "auto", "loose"].indexOf(e) && -1 !== [8208, 8211, 12316, 12448]
					...
					return r.push(B), 31 === a ? t.push("strict" === e ? g : T) : a === b ? t.push(H) : 29 === a ? t.push(H) : 43 === a ? A >=
						131072 && A <= 196605 || A >= 196608 && A <= 262141 ? t.push(T) : t.push(H) : void t.push(a)
				}), [r, t, n]
			},
			k = function (A, e, t, r) {
				var n = r[t];
			...
			G = function (A, e, t, r, n) {
				...
				if (-1 !== [E, f].indexOf(o) && (b === F || -1 !== [C, l].indexOf(b) && e[s + 1] === F) || -1 !== [C, l].indexOf(o) && b === F || o ===
					F && -1 !== [F, h, d].indexOf(b)) return L;
				...
				if (m === o && -1 !== [m, v, I, K].indexOf(b) || -1 !== [v, I].indexOf(o) && -1 !== [v, y].indexOf(b) || -1 !== [y, K].indexOf(o) &&
					b === y) return L;
			...
			return n(A, [{
				...
				value: function (A) {
					var e = u(A),
						...
						w = c[0],
						U = c[1];
					this.renderNodeBackgroundAndBorders(A.container), n.sort(Q).forEach(this.renderStack, this), this.renderNodeContent(A.container),
						U.forEach(this.renderNode, this), s.forEach(this.renderStack, this), o.forEach(this.renderStack, this), w.forEach(this.renderNode,
							this), B.forEach(this.renderStack, this), a.sort(Q).forEach(this.renderStack, this)
				}
			}, {
				key: "render",
				value: function (A) {
		...
		var Q = e.DocumentCloner = function () {
			...
			C = function (A, e, t, r, n) {
				if (t && t.content && "none" !== t.content && "-moz-alt-content" !== t.content && "none" !== t.display) {
					...
					return B.className = f + " " + E, e.className += n === d ? " " + f : " " + E, n === d ? e.insertBefore(B, e.firstChild) : e.appendChild(
						B), B
				}
			},
			d = ":before",
		...
		var s = function () {
			function A(e, t, r) {
				a(this, A), this.options = e, this._window = r, this.origin = this.getOrigin(r.location.href), this.cache = {}, this.logger = t,
					this._index = 0
			}
			return r(A, [{
				key: "loadImage",
				...
				value: function (A) {
					var e = this;
					return u(A) ? g(A, this.options.imageTimeout || 0) : this.hasResourceInCache(A) ? this.cache[A] : this.isSameOrigin(A) ||
						"string" != typeof this.options.proxy ? this.xhrImage(A) : this.cache[A] = (0, B.Proxy)(A, this.options).then(function (A) {
							return g(A, e.options.imageTimeout || 0)
						})
				}
			}, {
