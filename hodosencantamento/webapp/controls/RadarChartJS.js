// Provides control hodos.hodosencant.controls.chartjs.RadarChartJS
sap.ui.define([
	"./BaseChartJS"
	 ...
	 * @public
	 * @since 1.40
	 * @name hodos.hodosencant.controls.chartjs.RadarChartJS
	 */
	var RadarChartJS =  BaseChartJS.extend("hodos.hodosencant.controls.RadarChartJS", {
		
		metadata : {
			//library: 'hodos.hodosencant.controls.chartjs',
			properties: {
